...
/**
 * The RequestEnhancer interface must be implemented by classes that want to
 * enhance the Http-Requests that VJDBC sends to the VJDBC-Servlet. This way
 * it's possible to send connection specific data like authentication cookies.
 * 
 * @author Mike
 */
