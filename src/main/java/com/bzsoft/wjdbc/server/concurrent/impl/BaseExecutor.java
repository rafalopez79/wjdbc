...
public class BaseExecutor implements Executor {
    ...
    public BaseExecutor(final int numThreads, final int maxThreads) {
        ...
        workerPool = new ThreadPoolExecutor(numThreads, maxThreads, 2, TimeUnit.MINUTES,
                new LinkedBlockingQueue<Runnable>(), new BaseThreadFactory("WJDBCWorker"));
    }
    ...
    @Override
    public <T> Future<T> schedule(final Runnable command, final long initialDelay, final long period,
            final TimeUnit unit) {
