...
public class WCallableStatementPooled extends WPreparedStatementPooled implements CallableStatement {

	private final CallableStatement	callableStatement;

	public WCallableStatementPooled(final CallableStatement callableStatement, final PooledConnectionSubject subject) {
	...
	public <T> T getObject(final int col, final Class<T> clazz) throws SQLException {
		SQLException sqle = null;
		try {
			return callableStatement.getObject(col, clazz);
		} catch (final SQLException e) {
			sqle = e;
			throw sqle;
		} catch (final Throwable th) {
