 ...
 */
/**
 * Now this is tricky: We force the Deflater to flush its data by switching
 * compression level. As yet, a perplexingly simple workaround for
...
public class CompressingOutputStream extends DeflaterOutputStream {
	...
	public CompressingOutputStream(final OutputStream out, final int compressionMode) {
		super(out, new Deflater(compressionMode, true));
