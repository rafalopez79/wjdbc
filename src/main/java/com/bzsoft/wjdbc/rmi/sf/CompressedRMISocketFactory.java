...
/**
 * An RMISocketFactory which enables compressed transmission. We use {@link #CompressingInputStream} and
 * {@link #CompressingOutputStream} for this.
 * 
 * As we extend WrappingSocketFactory, this can be used on top of another {@link RMISocketFactory}.
 */
